    ...
    for a=1:numtriggercodes
        ...
        if a == 1 || a == 2
            for b=1:2
                ...
                % Include whatever you need to do to the datasets here. The
                % way this is currently set up, this will apply to datasets
                % with trigger codes 31 or 32 and acronyms INMA or CNMA.
        ...
        elseif a == 3
            for b=3:4
                ...
                % Include the same information as above here. The way this
                % is currently set up, this will apply to datasets with
                % trigger code 51 and acronym IN or CN.
