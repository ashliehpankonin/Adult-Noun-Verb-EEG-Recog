...
% This script appends the 31&32_INMA and 31&32_CNMA individual subject
...
for s=1:numsubjects
    ...
    for b=1:2 
        ...
        % Load ERP sets
        subjectsetname = [subject '_recog_31&32_' acronym '_ERPs_renamedbins_app_combobin_new.erp'];
    ...
    ERP = pop_savemyerp(ERP, 'erpname', [subject '_recog_31&32_INMA&CNMA_ERPs_renamedbins_app'], 'filename',[subject '_recog_31&32_INMA&CNMA_ERPs_renamedbins_app.erp'], 'filepath', subjectfolder, 'Warning','off');
    ...
    ERP = pop_savemyerp(ERP, 'erpname', [subject '_recog_31&32_IMA&CMA_ERPs_renamedbins_app'], 'filename',[subject '_recog_31&32_IMA&CMA_ERPs_renamedbins_app.erp'], 'filepath', subjectfolder, 'Warning','off');
